...
public class Kittens {
    public static void main(String[] args) {
        ...
        ArrayList<Double> snezhok = new ArrayList<Double>();
        ...
        ArrayList<Double> chernysh = new ArrayList<Double>();
        ...
        ArrayList<Double> ushastik = new ArrayList<Double>();
        ...
        ArrayList<Double> ryzhik = new ArrayList<Double>();
